...
def infer_country(dataset, pseudo_labels, guidebook, country_to_id):
  '''
  Infer the country from the pseudo labels
  :param dataset: pd.DataFrame, dataset containing the image ids
  :param pseudo_labels: dict, dictionary containing image to clues maping
  :param guidebook: dict, dictionary containing the guidebook
  :param country_to_id: dict, dictionary containing the country to country id mapping
  '''
...
if __name__ == "__main__":
    ...
    # Create the country name to  country id mapping
